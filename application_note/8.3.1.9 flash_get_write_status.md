<h3 id="8.3.1.9">8.3.1.9 flash_get_write_status</h3>
...
<a href="#Figure8.34">Figure 8.34</a> shows a flowchart of the flash_get_write_status() implementation in the default IPL.  
...
<center><img src="image/Figure8.34.png"  width="70%"></center>

<center><h4 id="Figure8.34">Figure 8.34 Flowchart of flash_get_write_status</h4></center>

### P1. Read Status Register

AT25QL128A has Status Register shown in <a href="#Table8.6">Table 8.6.</a>
...
Refer to <a href="8.3.1.11 flash_read_status_reister1_flash_read_status_register2.md#8.3.1.11">8.3.1.11</a> for how to read the Status Register.
...
<center><h4 id="Table8.6">Table 8.6 BUSY bit of AT25QL128A Status Register (BIT7 - BIT0)</h4>
