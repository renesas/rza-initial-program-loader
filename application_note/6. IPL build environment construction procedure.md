...
5.  Click [File] -> [New] -> [Makefile Project with Existing Code] in main window.
...
7.  Select "GCC for Renesas RZ (A-Profile AArch64 bare-metal)" in the Toolchain for Indexer Settings and click [Finish].
    ...
    <center><h4 id="Figure6.5">Figure 6.5 Create project (2)</h4></center>
...
8.  Right-click the [RZA3UL_IPL] project generated in Project Explorer and click [Properties].
    ...
    <center><h4 id="Figure6.6">Figure 6.6 Create project (3)</h4></center>
...
9.  Open [C / C ++ Build] -> [Tool Chain Editor] in Properties for [RZA3UL_IPL] and enter the build command.  
    ...
    <center><img src="image/Figure6.7.png" width="75%"></center>

    <center><h4 id="Figure6.7">Figure 6.7 Create project (4)</h4></center>
...
10.  Open [C/C ++ Build] -> [Behavior] in Properties for RZA3UL_IPL and enter the build command.  
     ...
     <center><h4 id="Figure6.8">Figure 6.8 Build Command</h4></center>
...
This option cannot be omitted</td>
<td>
<strong>a3ul_smarc_qsp</strong>i:<br>
...
11. Open [C / C ++ Build]-> [Environment] in Properties for [RZA3UL_IPL] and enter the Environment variables.  
    ...
    Set the environment variables of the combinations shown in the <a href="#Table6.2">Table 6.2</a> (for Windows10) or <a href="#Table6.3">Table 6.3</a> (for Ubuntu 22.04 LTS) in the Name and Value fields, then click [Apply].

    <center><img src="image/Figure6.9.png" width="75%"></center>

    <center><h4 id="Figure6.9">Figure 6.9 Build Environment</h4></center>

<h4 id="Table6.2">Table 6.2 Environment Variables (Windows10)</h4>
...
12. Right-click [RZA3UL_IPL] and click [Build Project] to run the build.  
    If you want to clean it, click [Clean Project].
