<h3 id="8.3.1.11">8.3.1.11 flash_read_status_reister1 / flash_read_status_register2</h3>
...
<a href="#Figure8.36">Figure 8.36</a> shows a flowchart of the flash_read_status_register1() implementation in the default IPL.
...
<center><img src="image/Figure8.36.png"  width="70%"></center>

<center><h4 id="Figure8.36">Figure 8.36 Flowchart of flash_read_status_register1</h4></center>
...
<a href="#Table8.8">Table 8.8</a> shows the settings of op_read_status1 when using the Read Status Register1 operation, and <a href="#Table8.9">Table 8.9</a> shows the settings of op_read_status2 when using the Read Status Register2 operation.
...
<h4 id="Table8.8">Table 8.8 op_read_status1 setting contents when using Read Status Register1 (0x05)</h4>
...
<h4 id="Table8.9">Table 8.9 op_read_status2 setting contents when using Read Status Register2 (0x35)</h4>
