<h3 id="8.4.1.13">8.4.1.13 flash_set_qe</h3>
...
<a href="#Figure8.4.1.13.1">Figure 8.4.1.13.1</a> show the flowchart of the flash_set_qe() implementation in the default IPL.
...
<center><img src="image/Figure8.4.1.13.1.png"  width="70%"></center>

<center><h4 id="Figure8.4.1.13.1">Figure 8.4.1.13.1 Flowchart of flash_set_qe</h4></center>

### P1. Check Quad Enable

The flash_set_qe() function once obtains the Status Register value shown in <a href="#Table8.4.1.13.1">Table 8.4.1.13.1</a> and skips processing if the QE bit has already been set.  
...
Refer to <a href="08.04.01.11 flash_read_status_reister1_flash_read_status_register2.md#8.4.1.11">8.4.1.11</a> for processing details.

<h4 id="Table8.4.1.13.1">Table 8.4.1.13.1 QE bit and SRP1 bit of AT25QL128A Status Register (BIT15 - BIT8)</h4>
...
Please refer to <a href="08.04.01.12 flash_write_status_register2.md#8.4.1.12">8.4.1.12</a> for changing the writing method to the Status Register.
