<h3 id="8.4.1.12">8.4.1.12 flash_write_status_register2</h3>
...
<a href="#Figure8.4.1.12.1">Figure 8.4.1.12.1</a> shows a flowchart of the flash_write_status_register2() implementation in the default IPL.
...
<center><img src="image/Figure8.4.1.12.1.png"  width="40%"></center>

<center><h4 id="Figure8.4.1.12.1">Figure 8.4.1.12.1 Flowchart of flash_write_status_register2</h4></center>
...
<a href="#Table8.4.1.12.1">Table 8.4.1.12.1</a> shows the settings of op_write_status2 when using the Write Status Register2 operation.
...
<h4 id="Table8.4.1.12.1">Table 8.4.1.12.1 op_write_status2 setting contents when using Write Status Register2 (0x31)</h4>
