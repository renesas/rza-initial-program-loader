<h3 id="8.3.3">8.3.3 How to add a Module for Clock Supply</h3>

In IPL, clocks are supplied to the modules shown in the CPG column of <a href="4.2.1 Peripheral Function Setting when using Serial Flash memory.md#Table4.1">Table 4.1</a>, resets are released, and the modules are made available.
...
2. Add the setting table of the module to be supplied with the clock to cpg_clk_on_tbl[].
   ...
   <center><img src="image/Figure8.45.png" width="100%"></center>

   <center><h4 id="Figure8.45">Figure 8.45 Information of cpg_clk_om_tbl[]</h4></center>
...
4. Add the setting table of the module to be reset to cpg_reset_tbl[]
   ...
   <center><img src="image/Figure8.46.png" width="100%"></center>

   <center><h4 id="Figure8.46">Figure 8.46 Information of cpg_reset_tbl[]</h4></center>
