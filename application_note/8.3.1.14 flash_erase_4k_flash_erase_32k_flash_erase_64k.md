<h3 id="8.3.1.14">8.3.1.14 flash_erase_4k / flash_erase_32k / flash_erase_64k</h3>
...
<a href="#Figure8.39">Figure 8.39</a> shows a flowchart of the flash_erase_4k() / flash_erase_32k() / flash_erase_64k() implementation in the default IPL.
...
<center><img src="image/Figure8.39.png"  width="40%"></center>

<center><h4 id="Figure8.39">Figure 8.39 Flowchart of flash_erase_4k/32k/64k</h4></center>
...
<a href="#Table8.12">Table 8.12</a> shows the op_erase_4k settings when using the 4-Kbytes Block Erase operation, <a href="#Table8.13">Table 8.13</a> shows the op_erase_32k settings when using the 32-Kbytes Block Erase operation, and <a href="#Table8.14">Table 8.14</a> shows the op_erase_64k settings when using the 64-Kbytes Block Erase operation.  
...
<h4 id="Table8.12">Table 8.12 op_erase_4k setting contents when using Block Erase (4 kbytes) operation (0x20)</h4>
...
<h4 id="Table8.13">Table 8.13 op_erase_32k setting contents when using Block Erase (32 kbytes) operation (0x52)</h4>
...
<h4 id="Table8.14">Table 8.14 op_erase_64k setting contents when using Block Erase (64 kbytes) operation (0xD8)</h4>
