...
1. Launch the e<sup>2</sup> studio installation wizard.
    ...
    <center><img src="image/Figure5.1.png" width="80%"></center>    

    <center><h4 id="Figure5.1">Figure 5.1 e<sup>2</sup> studio installation wizard</h4></center>    
    ...
    <center><img src="image/Figure5.2.png" width="50%"></center>

    <center><h4 id="Figure5.2">Figure 5.2: Select User for Installation</h4></center>
    ...
    <center><img src="image/Figure5.3.png" width="80%"></center>

    <center><h4 id="Figure5.3">Figure 5.3 e<sup>2</sup> studio installation wizard</h4></center>
...
2. "Welcome page"
    ...
    <center><img src="image/Figure5.4.png" width="80%"></center>

    <center><h4 id="Figure5.4">Figure 5.4 Installation of e<sup>2</sup> studio - Welcome page</h4></center>
...
3. "Device Families"
    ...
    <center><img src="image/Figure5.5.png" width="80%"></center>

    <center><h4 id="Figure5.5">Figure 5.5 Installation of e<sup>2</sup> studio - Device Families</h4></center>
...
4. "Extra Features"
    ...
    <center><img src="image/Figure5.6.png" width="80%"></center>

    <center><h4 id="Figure5.6">Figure 5.6 Installation of e<sup>2</sup> studio - Extra Features</h4></center>

5. "Customize Features"

    Be sure to select [Renesas FSP Smart Configurator Core].

    <center><img src="image/Figure5.7.png" width="80%"></center>

    <center><h4 id="Figure5.7">Figure 5.7 Installation of e<sup>2</sup> studio - Features</h4></center>
...
6. "Additional Software"
    ...
    * GCC ARM A-Profile (AArch64 bare-metal) 10.3.2021.07<br>
    ...
    <center><img src="image/Figure5.8.png" width="80%"></center>

    <center><h4 id="Figure5.8">Figure 5.8 Installation of e<sup>2</sup> studio - Additional Software</h4></center>
...
7. "License Agreement"
    ...
    <center><img src="image/Figure5.9.png" width="80%"></center>

    <center><h4 id="Figure5.9">Figure 5.9 Installation of e<sup>2</sup> studio - Licenses</h4></center>
...
8. "Shortcuts"
    ...
    <center><img src="image/Figure5.10.png" width="80%"></center>

    <center><h4 id="Figure5.10">Figure 5.10 Installation of e<sup>2</sup> studio - Shortcuts</h4></center>
...
9. "Summary"
    ...
    <center><img src="image/Figure5.11.png" width="80%"></center>

    <center><h4 id="Figure5.11">Figure 5.11 Installation of e<sup>2</sup> studio - Summary</h4></center>
...
11. "Results"
    ...
    <center><img src="image/Figure5.12.png" width="80%"></center>

    <center><h4 id="Figure5.12">Figure 5.12 Results Page</h4></center>
