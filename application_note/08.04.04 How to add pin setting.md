<h3 id="8.4.4">8.4.4 How to add pin setting</h3>

In IPL, the pin setting shown in the GPIO column of <a href="04.02.01 Peripheral Function Setting when using Serial Flash memory.md#Table4.2.1.1">Table 4.2.1.1</a> is performed.
...
2. Add the pin setting table to pfc_mux_reg_tbl[].
   ...
   <center><img src="image/Figure8.4.4.1.png" width="100%"></center>

   <center><h4 id="Figure8.4.4.1">Figure 8.4.4.1 Information of pfc_mux_reg_tbl[]</h4></center>
