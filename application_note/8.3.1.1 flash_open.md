<h3 id="8.3.1.1">8.3.1.1 flash_open</h3>
...
<a href="#Figure8.22">Figure 8.22</a> shows a flowchart of the flash_open() implementation in the default IPL.
...
<center><img src="image/Figure8.22.png"  width="70%"></center>

<center><h4 id="Figure8.22">Figure 8.22 Flowchart of flash_open</h4></center>

### P1. Clock Frequency setting change

flash_open sets the operating clock frequency of the Serial Flash memory.  
The defined value of DEFAULT_SPI_FREQUENCY in L14 of qspiflash_custom.c shown in <a href="#Figure8.23">Figure 8.23</a> is used for the operating clock frequency.  
...
<center><img src="image/Figure8.23.png"  width="70%"></center>

<center><h4 id="Figure8.23">Figure 8.23 Change operation clock frequency</h4></center>

### P2. Serial Flash memory register setting

In AT25QL128A, QE bit of Status Register shown in <a href="#Table8.3">Table 8.3</a> must be set to enable Quad operation.  
The QE bit of the Status Register is set by the subfunction flash_set_qe() function.  
Refer to <a href="8.3.1.13 flash_set_qe.md#8.3.1.13">8.3.1.13</a> when changing the QE bit setting method.

<h4 id="Table8.3">Table 8.3 QE bit of AT25QL128A Status Register (BIT15 - BIT8)</h4>
