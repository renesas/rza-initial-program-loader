<h3 id="8.3.1.7">8.3.1.7 flash_write</h3>
...
<p>To enable write process, refer to <a href="#Figure8.29">Figure 8.29</a> and rewrite RZ_XSPIFLASH_DISABLE_WRITE:=1 in rz_xspi_common.mk L13 to RZ_XSPIFLASH_DISABLE_WRITE:=0 and rebuild.</p></td>
</tr>
</tbody>
</table>
<center><img src="image/Figure8.29.png"  width="80%"></center>

<center><h4 id="Figure8.29">Figure 8.29 Change build switch for write function</h4></center>

<a href="#Figure8.30">Figure 8.30</a> and <a href="#Figure8.31">Figure 8.31</a> show the flowchart of the flash_write() implementation in the default IPL.  
...
<center><img src="image/Figure8.30.png"  width="70%"></center>

<center><h4 id="Figure8.30">Figure 8.30 Flowchart of flash_write</h4></center>

<center><img src="image/Figure8.31.png"  width="70%"></center>

<center><h4 id="Figure8.31">Figure 8.31 Flowchart of Data write process</h4></center>
...
<a href="#Table8.5">Table 8.5</a> shows the settings of op_page_program_dopi when using Quad Page program.  
When changing the Serial Flash memory, refer to <a href="#Table8.5">Table 8.5</a> and rewrite the setting contents of op_page_program to the contents corresponding to the Write operation of your Serial Flash memory.
...
<h4 id="Table8.5">Table 8.5 op_page_program setting contents when using Quad Page Program (0x33)</h4>
