...
1. Right-click on RZA3UL_IPL and select [Debug As] -> [Debug Configurations].
   ...
   <center><img src="image/Figure7.1.1.png" width="100%"></center>

   <center><h4 id="Figure7.1.1">Figure 7.1.1 Create Debug Configuration (1)</h4></center>
...
2. In the "Debug Configurations" window, double-click [Renesas GDB Hardware Debugging] to create a Debug Configuration template for the RZA3UL_IPL.  
   ...
   <center><img src="image/Figure7.1.2.png"  width="90%"></center>

   <center><h4 id="Figure7.1.2">Figure 7.1.2 Create Debug Configuration (2)</h4></center>
...
3. The Renesas GDB Hardware Debugging Launch Configuration Properties will show up.  
   ...
   <center><img src="image/Figure7.1.3.png"></center>

   <center><h4 id="Figure7.1.3">Figure 7.1.3 Create Debug Configuration (3)</h4></center>
...
4. Go to the [Debugger] tab.  
   ...
   <center><img src="image/Figure7.1.4.png"></center>

   <center><h4 id="Figure7.1.4">Figure 7.1.4 Create Debug Configuration (4)</h4></center>
...
5. Go to the "Debugger" -> "Connection Settings" tab.  
   ...
   <center><img src="image/Figure7.1.5.png" width="80%"></center>

   <center><h4 id="Figure7.1.5">Figure 7.1.5 Create Debug Configuration (5)</h4></center>
...
6. Go to the "Debugger"-> "Debug Tool Settings" tab.  
    ...
    * For OctaFlash : "Flash Bus Type" to [OctaBus], "Flash Memory Type" to [OctaFlash]

    Then, set "Run Break Time Measurement" to No.

   <center><img src="image/Figure7.1.6.png" width="100%"></center>

   <center><h4 id="Figure7.1.6">Figure 7.1.6 Create Debug Configuration (6)</h4></center>

   <center><img src="image/Figure7.1.7.png" width="80%"></center>

   <center><h4 id="Figure7.1.7">Figure 7.1.7 Change settings when using OctaFlash</center>

7. Go to "Startup" tab  
   Set "On connect" of "Program Binary" to [No].

   <center><img src="image/Figure7.1.8.png" width="80%"></center>

   <center><h4 id="Figure7.1.8">Figure 7.1.8 Create Debug Configuration (7)</h4></center>
...
8. Click [Add] to bring up the Add download module window.  
   ...
   <center><img src="image/Figure7.1.9.png" width="100%"></center>

   <center><h4 id="Figure7.1.9">Figure 7.1.9 Create Debug Configuration (8)</h4></center>
...
9. Since IPL write destination address H'2000_0000 is set in the registered rza3ul_smarc_qspi_ipl.srec itself, set [0] to "Offset(hex)".  
   ...
   <center><img src="image/Figure7.1.10.png" width="75%"></center>

   <center><h4 id="Figure7.1.10">Figure 7.1.10 Create Debug Configuration of Serial Flash (9)</h4></center>
...
10. Go to the Common tab and set Save as to Shared file:, and set the path to [\RZA3UL_IPL].  
   ...
   <center><img src="image/Figure7.1.11.png" width="75%"></center>

   <center><h4 id="Figure7.1.11">Figure 7.1.11 Create Debug Configuration (10)</h4></center>
