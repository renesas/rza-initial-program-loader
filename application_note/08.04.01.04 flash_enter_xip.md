<h3 id="8.4.1.4">8.4.1.4 flash_enter_xip</h3>
...
In External Space Address Read Mode, when a read access is made to the Serial Flash memory area (H'20000000) in the memory space shown in <a href="04.03.01 Memory Map of RZA3UL SMARC EVK board (QSPI version).md#Figure4.3.1.1">Figure 4.3.1.1</a>, SPIBSC automatically performs serial communications and data is read from that address in the Flash memory.
...
<a href="#Figure8.4.1.4.1">Figure 8.4.1.4.1</a> shows a flowchart of the flash_enter_xip() implementation in the default IPL.
...
<center><img src="image/Figure8.4.1.4.1.png"  width="70%"></center>

<center><h4 id="Figure8.4.1.4.1">Figure 8.4.1.4.1 Flowchart of flash_enter_xip</h4></center>
...
<a href="#Table8.4.1.4.1">Table 8.4.1.4.1</a> shows the rop settings when using the Fast Read quad I/O operation.
...
<h4 id="Table8.4.1.4.1">Table 8.4.1.4.1 rop setting contents when using Fast Read quad I/O(0xEB)</h4>
...
The defined value of DEFAULT_SPI_FREQUENCY in L14 of qspiflash_custom.c shown in <a href="08.04.01.01 flash_open.md#Figure8.4.1.1.2">Figure 8.4.1.1.2</a> is used for the operating clock frequency.  
