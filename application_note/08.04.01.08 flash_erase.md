<h3 id="8.4.1.8">8.4.1.8 flash_erase</h3>
...
<p>To enable erase process, refer to <a href="08.04.01.07 flash_write.md#Figure8.4.1.7.1">Figure 8.4.1.7.1</a> and rewrite RZ_XSPIFLASH_DISABLE_WRITE:=1 in rz_xspi_common.mk L13 to RZ_XSPIFLASH_DISABLE_WRITE:=0 and rebuild.</p></td>
</tr>
</tbody>
</table>

<a href="#Figure8.4.1.8.1">Figure 8.4.1.8.1</a> and <a href="#Figure8.4.1.8.2">Figure 8.4.1.8.2</a> show the flowchart of the flash_erase() implementation in the default IPL.
...
<center><img src="image/Figure8.4.1.8.1.png"  width="70%"></center>

<center><h4 id="Figure8.4.1.8.1">Figure 8.4.1.8.1 Flowchart of flash_erase</h4></center>

<center><img src="image/Figure8.4.1.8.2.png"  width="70%"></center>

<center><h4 id="Figure8.4.1.8.2">Figure 8.4.1.8.2 Flowchart of Erase process</h4></center>
...
Refer to <a href="08.04.01.14 flash_erase_4k_flash_erase_32k_flash_erase_64k.md#8.4.1.14">8.4.1.14</a>  for how to change the erase operation execution process.
