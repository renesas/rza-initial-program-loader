<h3 id="8.4.1.10">8.4.1.10 flash_write_enable</h3>
...
<a href="#Figure8.4.1.10.1">Figure 8.4.1.10.1</a> shows a flowchart of the flash_write_enable() implementation in the default IPL.  
...
<center><img src="image/Figure8.4.1.10.1.png"  width="40%"></center>

<center><h4 id="Figure8.4.1.10.1">Figure 8.4.1.10.1 Flowchart of flash_write_enable</h4></center>
...
<a href="#Table8.4.1.10.1">Table 8.4.1.10.1</a> shows the op_write_enable settings when using the Write Enable operation.  
When changing the Serial Flash memory, refer to <a href="#Table8.4.1.10.1">Table 8.4.1.10.1</a> and rewrite the setting contents of op_write_enable to the contents equivalent to the Write Enable operation of your Serial Flash memory.  
...
<h4 id="Table8.4.1.10.1">Table 8.4.1.10.1 op_write_enable setting contents when using Write Enable (0x06)</h4>
