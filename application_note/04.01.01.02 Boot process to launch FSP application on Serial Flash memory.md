...
<a href="#Figure4.1.1.2.1">Figure 4.1.1.2.1</a> shows an operation image when jumping directly to the FSP application written in the Serial Flash memory and executing it.

    Note:  
    Serial NAND Flash memory cannot run programs such as FSP applications.

![](image/Figure4.1.1.2.1.png)

<center><h4 id="Figure4.1.1.2.1">Figure 4.1.1.2.1 Operation image when booting FSP application on Serial Flash memory</h4></center>
